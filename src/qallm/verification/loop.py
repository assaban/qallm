...
as a VerificationSession for reproducibility and analysis.
...
class VerificationLoop:
    ...
    def run(
        ...
        Returns:
            VerificationSession with all round results and aggregate metrics.
        """
        ...
        for round_num in range(1, self.rounds + 1):
            ...
            if round_num == 1:
                ...
                from qallm.verification.generator import _fix_source_import, _strip_markdown_fences, _validate_test_code
...
def save_session(session: VerificationSession, output_path: Path) -> None:
